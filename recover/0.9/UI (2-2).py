...
class Initor_for_btn(QtWidgets.QMainWindow):
    ...
    def init_left(self):
        ...
        self.left_button_rec = QtWidgets.QPushButton(
            qtawesome.icon('fa.table', color='white'), '打开报表')
        ...
        self.left_button_show = QtWidgets.QPushButton(
            qtawesome.icon('fa.book', color='white'), '显示情况')
        ...
        self.left_layout.addWidget(self.left_button_init, 7, 0, 1, 3)
...
class MainUi(Initor_for_event):
    ...
    def init_baobiao(self):
        #print("1")
        file_infos_list = []
        os.chdir(r"E:\face2\face_dataset")
        ...
        for file_name in glob.glob("*.jpg"):
            file_name = file_name.split('.')[0]
            file_infos_list.append(file_name)
        with open('E:/face2/1.csv', "w", newline='', encoding='utf-8-sig') as csv_file:
            headers = ['姓名']
